...
<nav
    ...
    <div id="top-menu" class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme">
        <ul class="d-flex justify-content-center list-unstyled mb-0">
          <li class="mx-3"><a href="/admin/dashboard" class="text-decoration-none text-dark">Dashboards</a></li>
          <li class="mx-3"><a href="/admin/barang" class="text-decoration-none text-dark">Barang</a></li>
          <li class="mx-3"><a href="/admin/satuan" class="text-decoration-none text-dark">Satuan</a></li>
          <li class="mx-3"><a href="/admin/layouts" class="text-decoration-none text-dark">Layouts</a></li>
          <li class="mx-3"><a href="/admin/forms" class="text-decoration-none text-dark">Forms</a></li>
        </ul>
      </div>
