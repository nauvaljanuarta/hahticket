    ...
    <div id="main-wrapper flex-column">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                        <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <img src="../assets/images/demos/demo-main.jpg" alt=""
                                                            class="img-fluid" />
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="../assets/images/demos/demo-dark.jpg" alt=""
                                                            class="img-fluid" />
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="../assets/images/demos/demo-rtl.jpg" alt=""
                                                            class="img-fluid" />
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row justify-content-between">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="../assets/images/apps/app-chat.jpg" alt=""
                                                            class="img-fluid" />
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="../assets/images/apps/app-email.jpg" alt=""
                                                            class="img-fluid" />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="position-relative">
                                                                ...
                                                                <a target="_blank" href="../main/app-notes.html"
                                                                    class="d-flex align-items-center pb-6 position-relative lh-base">
                                                                    <div
                                                                        class="bg-light rounded me-3 p-8 d-flex align-items-center justify-content-center">
                                                ...
                                                <ul class="list-unstyled">
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary"
                                                            target="_blank" href="../main/page-pricing.html">Pricing
                                                            Page</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary"
                                                    ...
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary"
                                                            target="_blank" href="../main/app-notes.html">Notes
                                                            App</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary"
                                                            target="_blank"
                                                            href="../main/page-user-profile2.html">User Application</a>
                                                    </li>
                                                    <li class="mb-3">
                                                        <a class="fw-semibold text-dark text-hover-primary"
                                                            target="_blank"
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="https://support.wrappixel.com/"
            ...
            <section class="hero-section bg-body-secondary position-relative overflow-hidden">
                        ...
                        <div class="col-lg-9 pt-lg-5">
                            <div class="text-center pt-5">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-center gap-8 mb-8 pb-7"
                                    ...
                                    <a class="btn btn-outline-primary rounded-pill d-block" href="../docs/index.html"
                                        target="_blank">Documentation</a>
                                </div>
                                <ul class="list-unstyled d-inline-flex w-auto align-items-center justify-content-center mb-0 gap-3 bg-white rounded-pill p-3"
                                    ...
                                    <li>
                                        <img src="../assets/images/svgs/icon-bootstrap.svg" alt="" />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <img src="../assets/images/svgs/icon-figma.svg" alt="" />
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <img src="../assets/images/svgs/icon-jquery.svg" alt="" />
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="sliding-wrapper position-relative overflow-hidden py-5">
                    <div class="slide-background d-flex flex-row w-100 gap-3 py-lg-7">
                        <div class="slide">
                            <img src="../assets/images/slider/slider-group.png" alt="slide" />
                        </div>
                        <div class="slide">
                            <img src="../assets/images/slider/slider-group.png" alt="slide" />
                        </div>
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                    ...
                                    <div class="bg-light p-3 pb-0">
                                        <div
                                            class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                            <img src="../assets/images/demos/demo-horizontal.jpg" alt=""
                                                class="img-fluid" />
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                    ...
                                    <div class="bg-light p-3 pb-0">
                                        <div
                                            class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                            <img src="../assets/images/demos/demo-minisidebar.jpg" alt=""
                                                class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-calendar.jpg" alt=""
                                                    class="img-fluid" />
                                                <a target="_blank" href="../main/app-calendar.html"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-contact.jpg" alt=""
                                                    class="img-fluid" />
                                                <a target="_blank" href="../main/app-contact2.html"
                                                    class="btn btn-primary rounded-pill live-preview-btn">Live
                                                    Preview</a>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-invoice.jpg" alt=""
                                                    class="img-fluid" />
                                                <a target="_blank" href="../main/app-invoice.html"
                                                    class="btn btn-primary rounded-pill live-preview-btn">Live
                                                    Preview</a>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-contact-list.jpg" alt=""
                                                    class="img-fluid" />
                                                <a target="_blank" href="../main/app-contact.html"
                                                    class="btn btn-primary rounded-pill live-preview-btn">Live
                                                    Preview</a>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/page-user-profile2.jpg" alt=""
                                                    class="img-fluid" />
                                                <a target="_blank" href="../main/page-user-profile2.html"
                                                    class="btn btn-primary rounded-pill live-preview-btn">Live
                                                    Preview</a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-blog.jpg" alt=""
                                                    class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-blog-details.jpg" alt=""
                                                    class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/eco-shop2.jpg" alt=""
                                                    class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-shop-details.jpg" alt=""
                                                    class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-product-list.jpg" alt=""
                                                    class="img-fluid" />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="deshboard-templete-items rounded-3 border position-relative overflow-hidden mb-4"
                                        ...
                                        <div class="bg-light p-3 pb-0">
                                            <div
                                                class="deshboard-templete-img rounded-top-2 overflow-hidden position-relative">
                                                <img src="../assets/images/apps/app-checkout.jpg" alt=""
                                                    class="img-fluid" />
            ...
            <section class="features-section bg-body-secondary py-7 py-lg-5">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex align-items-strech">
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="400"
                                data-aos-duration="1000">
                                <div class="card-body p-4">
                                    <div
                            ...
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="400"
                                ...
                                <div class="card-body p-4">
                                    <div
                                        ...
                                        <i class="d-block ti ti-language-katakana text-indigo fs-8"></i>
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex align-items-strech">
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="400"
                                ...
                                <div class="card-body p-4">
                                    <div
                                        class="bg-primary-subtle mb-4 p-8 rounded-1 d-inline-flex align-items-center justify-content-center">
                                        <i class="d-block ti ti-building-carousel text-primary fs-8"></i>
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex align-items-strech">
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="600"
                                data-aos-duration="1000">
                                <div class="card-body p-4">
                                    <div
                                        class="bg-danger-subtle mb-4 p-8 rounded-1 d-inline-flex align-items-center justify-content-center">
                                        <i class="d-block ti ti-arrows-shuffle text-danger fs-8"></i>
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex align-items-strech">
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="600"
                                ...
                                <div class="card-body p-4">
                                    <div
                                        class="bg-success-subtle mb-4 p-8 rounded-1 d-inline-flex align-items-center justify-content-center">
                                        <i class="d-block ti ti-layers-intersect text-success fs-8"></i>
                                    </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex align-items-strech">
                            <div class="card mb-4 w-100" data-aos="fade-up" data-aos-delay="800"
                                data-aos-duration="1000">
                                <div class="card-body p-4">
                                    <div
                                        class="bg-warning-subtle mb-4 p-8 rounded-1 d-inline-flex align-items-center justify-content-center">
        ...
        <div class="offcanvas offcanvas-start modernize-lp-offcanvas" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-header p-4">
                <img src="../assets/images/logos/logo-light.svg" alt="" class="img-fluid"
                    width="150" />
            </div>
            <div class="offcanvas-body p-4">
                <ul class="navbar-nav justify-content-end flex-grow-1">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu ps-2">
                            ...
                            <li>
                                <a class="dropdown-item text-dark" target="_blank"
                                    href="../main/index.html">main</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-dark" target="_blank"
                                    href="../minisidebar/index.html">Minisidebar</a>
                            </li>
                            <li>
                                <a class="dropdown-item text-dark" target="_blank"
                                    href="../rtl/index.html">RTL</a>
                            </li>
                        </ul>
                    </li>
                ...
                <form class="d-flex mt-3" role="search">
                    <a class="btn btn-primary btn-hover-shadow rounded-pill w-100"
                        href="https://discord.com/invite/eMzE8F6Wqs">Live Help</a>
                </form>
            </div>
        </div>
    </div>
